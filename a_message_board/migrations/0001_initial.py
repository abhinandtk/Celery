# Generated by Django 5.2.4 on 2026-02-16 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messageboard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='a_message_board.messageboard')),
            ],
            options={
                'ordering': ['-created'],
            },
